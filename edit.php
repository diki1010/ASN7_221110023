...
if (isset($_POST['update'])) {
    ...
    $qUpdate = "UPDATE barang 
                SET nama_barang = '$nama', id_kategori = $kategori, harga = $harga 
...
<main class="container-fluid px-4 px-md-5 mb-4 mt-3">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h5 class="mb-0 text-dark fw-semibold">Edit Barang</h5>
        ...
        <div class="card-body">
            <form method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nama" name="nama" value="<?= $data['nama_barang'] ?>" required>
                </div>
                <div class="mb-3">
