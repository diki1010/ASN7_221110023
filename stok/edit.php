...
$id = $_GET['id'];
$data = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM stok WHERE id_stok = $id"));
...
if (isset($_POST['update'])) {
    ...
    $update = mysqli_query($conn, "UPDATE stok SET tanggal='$tanggal', jumlah=$jumlah, tipe='$tipe' WHERE id_stok = $id");
    if ($update) {
        header("Location: index.php?msg=Data stok berhasil diupdate.");
        exit;
    } else {
...
<main class="container-fluid px-4 px-md-5 mb-4 mt-3">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h5 class="mb-0 text-dark fw-semibold">Edit Data Stok</h5>
        ...
        <div class="card-body">
            <form method="POST">
                <div class="mb-3">
                    ...
                    <input type="text" value="<?= $data['kode_barang'] ?>" class="form-control" disabled>
                </div>
                <div class="mb-3">
